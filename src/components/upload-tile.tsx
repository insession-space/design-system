...
const TILE =
  'relative flex w-full cursor-pointer flex-col items-center justify-center gap-2.5 rounded-card border-[length:1.5px] border-dashed p-4 text-center transition-colors duration-(--dur-fast) focus-within:shadow-focus';
