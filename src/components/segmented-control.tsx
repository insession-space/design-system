...
const SEGMENT =
  'inline-flex shrink-0 cursor-pointer items-center justify-center gap-1.5 rounded-[7px] border-none bg-transparent px-3 py-1.5 font-body text-sm font-semibold whitespace-nowrap transition-colors duration-(--dur-fast) focus-visible:shadow-focus focus-visible:outline-none data-disabled:cursor-not-allowed data-disabled:opacity-50';
