...
export function StatusBadge({
  ...
  return (
    <span
      className={`inline-flex shrink-0 items-center gap-1.5 rounded-pill border border-solid px-2 py-0.5 text-2xs font-extrabold uppercase tracking-[0.06em] ${BADGE_TONE[tone]} ${className}`.trim()}
    >
